...
void loop()
{
 ...
 client.print(" ");
 int intensidadLuminosa = analogRead(0); // en C es posible declarar variable aquí
 client.print("<html>");
 client.print("<h2> El nivel de intensidad luminosa captado por LDR es: </h2>");
 client.print("<h2>");
 client.print( intensidadLuminosa );
 client.print("</h2>");
 client.print("</html>");
 client.print(" ");
